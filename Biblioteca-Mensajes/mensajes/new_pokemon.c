...
char* new_pokemon_to_string(t_new_pokemon* new_pokemon){
	return string_from_format("Mensaje - New Pokemon: Nombre: %s, Posicion x: %d, Posicion y: %d, Cantidad: %d, ",new_pokemon->pokemon->especie,new_pokemon->pokemon->posicion.posicionX,new_pokemon->pokemon->posicion.posicionY,new_pokemon->cantidad);
}
