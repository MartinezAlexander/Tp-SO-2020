...
t_appeared_pokemon* appeared_pokemon_create(char* nombre, uint32_t posX, uint32_t posY){
	...
	appeared_pokemon->tamanio_nombre = strlen(nombre);
...
t_buffer* appeared_pokemon_to_buffer(t_appeared_pokemon* appeared_pokemon){
	...
	buffer->stream = appeared_pokemon_to_stream(appeared_pokemon);
	return buffer;
}

t_appeared_pokemon* appeared_pokemon_from_buffer(t_buffer* buffer){
	return appeared_pokemon_from_stream(buffer->stream);
}
...
void* appeared_pokemon_to_stream(t_appeared_pokemon* appeared_pokemon){
	int size = sizeof(uint32_t) * 3 + appeared_pokemon->tamanio_nombre;
